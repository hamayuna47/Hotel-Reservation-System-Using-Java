...
public class checkoutcontroller implements Initializable {
    ...
    @FXML
    private TableColumn<Occupancy, String> usercol;
    @FXML
    private TableColumn<Occupancy, String> roomcol;
    ...
    ObservableList<Occupancy>  OccupancyList;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        OccupancyList = DBUtils.getoccupancy(data.getuserid());
        occupancytable.setItems(OccupancyList);
    	...
    	button_check.setOnAction(new EventHandler<ActionEvent>()
    	{
			...
			public void handle(ActionEvent event) {
				if(tf_roomno!=null) {
				  DBUtils.roomcheckout(tf_roomno.getText(), data.getuserid() , tf_fb.getText() , slide_stars.getValue());;
				}
			}
